...
const animateElements = document.querySelectorAll('.skill-category, .project-card, .stat, .about-text, .about-image');
...
console.log('⌨️ Use Tab to navigate, Enter to activate links');
